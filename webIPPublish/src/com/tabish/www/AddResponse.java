...
@SuppressWarnings(
	{"unchecked", "unused"})
public class AddResponse implements org.apache.axis2.databinding.ADBBean
	{
		/*
		 * This type was generated from the piece of schema that had name =
		 * addResponse Namespace URI = http://www.tabish.com Namespace Prefix =
		 * ns1
		 */
						...
						try
							{
												...
												if (!"addResponse".equals(type))
													{
														...
														java.lang.String nsUri = reader
														        ...
														        .getNamespaceURI(
														                nsPrefix);
														return (AddResponse) com.tabish.www.ExtensionMapper
														        .getTypeObject(
														                nsUri,
														                type,
														                reader);
								...
								if (reader.isStartElement()
								        && new javax.xml.namespace.QName("",
								                "return").equals(reader
								                .getName()))
									{

										object.set_return(com.tabish.www.HelloOutput.Factory
										        .parse(reader));
