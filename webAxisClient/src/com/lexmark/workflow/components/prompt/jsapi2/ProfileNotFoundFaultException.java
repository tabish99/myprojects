...
public class ProfileNotFoundFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1420136561683L;
    
    private com.lexmark.workflow.components.prompt.jsapi2.JobSubmission2Stub.ProfileNotFoundFault faultMessage;
    ...
    public void setFaultMessage(com.lexmark.workflow.components.prompt.jsapi2.JobSubmission2Stub.ProfileNotFoundFault msg){
       faultMessage = msg;
    }
    
    public com.lexmark.workflow.components.prompt.jsapi2.JobSubmission2Stub.ProfileNotFoundFault getFaultMessage(){
       return faultMessage;
    }
}
